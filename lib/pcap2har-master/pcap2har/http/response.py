...
class Response(message.Message):
    ...
    * compression_amount: int or None, difference between lengths of
    ...
    def __init__(self, tcpdir, pointer):
        message.Message.__init__(self, tcpdir.rev, pointer, dpkt_http.Response)
        # get mime type
		...
		#add by xuxia
        #self.ts_start = tcpdir.rev.get_ts_by_index(1)
        #print ("response: %f ~ %f" %(self.ts_start, self.ts_end))
